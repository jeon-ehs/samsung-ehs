...
if weather_data['temp'] >= 33.0: 
    st.error("🚨 **[폭염 경보]** 온열질환 발생 위험! 옥외작업 최소화 및 휴식을 보장하세요.")
elif weather_data['temp'] <= -5.0: 
    st.info("🚨 **[한파 주의]** 동절기 한랭질환 및 빙판길 미끄러짐에 주의하세요.")
elif weather_data['rain'] > 0.0: 
    st.warning("☔ **[강우 주의]** 감전 및 미끄러짐 재해 위험이 높습니다.")
else: 
